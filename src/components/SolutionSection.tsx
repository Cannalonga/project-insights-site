const solutions = [
  ...
  "Identificação de inconsistências que impactam a confiabilidade da leitura.",
  "Comparação entre versões para mostrar o que mudou de verdade.",
  "Saída executiva em PDF, JSON estruturado e CSV para BI.",
];
        ...
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div className="max-w-xl">
            ...
            <p className="mt-5 text-lg leading-8 text-[var(--muted)]">
              Em vez de montar o entendimento manualmente, você carrega o cronograma e recebe uma leitura pronta para
              reunião, acompanhamento e ação, sem confundir detalhe operacional com confiabilidade analítica.
            </p>
          </div>
